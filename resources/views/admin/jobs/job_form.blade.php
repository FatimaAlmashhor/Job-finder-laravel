...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="card mb-4">
            ...
            <form class="card-body" method="POST" action={{ route('adminUploadJob') }} enctype="multipart/form-data">
                @csrf
                ...
                <div class="row mt-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" id="multicol-username" value='{{ old('sallary') }}' name='sallary'
                            class="form-control" placeholder="4000 - 6000" />
                        <span class="text-danger">{{ $errors->first('sallary') }}</span>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label" for="multicol-username">Location</label>
                        <input type="text" id="multicol-username" name='location' value='{{ old('location') }}'
