...
<html lang="en" class="light-style  customizer-hide" dir="ltr" data-theme="theme-semi-dark" data-assets-path="/adminAssests/" data-template="vertical-menu-template-semi-dark">
...
<link rel="stylesheet" href="/adminAssests/vendor/libs/formvalidation/dist/css/formValidation.min.css" />
    ...
    <!-- Page CSS -->
    <!-- Page -->
<link rel="stylesheet" href="/adminAssests/vendor/css/pages/page-auth.css">
    <!-- Helpers -->
...
<body>
            ...
            <div class="authentication-inner">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="formAuthentication" class="mb-3" action="{{ route('adminRegister') }}"
                            method="POST">
                            @csrf
                            <div class="mb-3">
                            ...
                            <div class="mb-3 form-password-toggle">
                                ...
                                <div class="input-group input-group-merge">
                                    <input type="password" id="password" class="form-control" name="cpassword"
                                        placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;"
                                        aria-describedby="password" value='{{ old('cpassword') }}' />
                                    <span class="input-group-text cursor-pointer"><i class="bx bx-hide"></i></span>
                                </div>
                            ...
                            <div class="mb-3">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="terms-conditions" name='checkAgree'>
                                        I agree to
    ...
    <!-- Vendors JS -->
    {{-- <script src="/adminAssests/vendor/libs/formvalidation/dist/js/FormValidation.min.js"></script>
    <script src="/adminAssests/vendor/libs/formvalidation/dist/js/plugins/Bootstrap5.min.js"></script>
    <script src="/adminAssests/vendor/libs/formvalidation/dist/js/plugins/AutoFocus.min.js"></script> --}}

    <!-- Main JS -->
    <script src="/adminAssests/js/main.js"></script>

    <!-- Page JS -->
    <script src="/adminAssests/js/pages-auth.js"></script>
